...
namespace Customer.Project.Utilities {
    public static class EnumExtensions
    {
        ...
        public static T Add<T>(this Enum type, T value)
        {
            ...
            {
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, "Could not append value from enumerated type '{0}'.", typeof(T).Name), ex);
            }
        }
        ...
        public static T Remove<T>(this Enum type, T value)
        {
            ...
            {
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture , "Could not remove value from enumerated type '{0}'.", typeof(T).Name), ex);
            }
        }
        ...
        public static T GetEnum<T>(this Enum type, string value) where T : struct
        {
            ...
            T outPutValue = (T)Enum.Parse(typeof(T), value, true);
            return outPutValue;
        }
